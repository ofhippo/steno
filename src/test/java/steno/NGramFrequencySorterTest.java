...
public class NGramFrequencySorterTest {
    ...
    public void sortByLikelihoodDescending() {
        ...
        List<String> results = NGramFrequencySorter.sortByLikelihoodDescending(context, candidateNextWords);
        ...
        results = NGramFrequencySorter.sortByLikelihoodDescending(context, candidateNextWords);
